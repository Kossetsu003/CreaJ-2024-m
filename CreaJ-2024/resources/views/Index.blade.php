...
<body>
    <div class="md:flex md:bg-indigo-200">
        <div class="flex justify-center items-center h-screen md:w-[50%] border-4">
            <div class=" p-8">
                <div>
                    <h3 class="font-bold text-6xl text-center ">Mini <span class="text-blue-500">Shop</span><h3>
                        <h3 class="mt-3 w-[90%] mx-auto md:text-white text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, impedit. Cum blanditiis pariatur autem, eveniet sed ipsam modi cupiditate quisquam.</h3>
                    </div>
