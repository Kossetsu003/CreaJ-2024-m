<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="contrasena" class="form-control @error('contrasena') is-invalid @enderror" value="{{ old('contrasena', $cliente?->contrasena) }}" id="contrasena" placeholder="Contrasena">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="sexo" class="form-control @error('sexo') is-invalid @enderror" value="{{ old('sexo', $cliente?->sexo) }}" id="sexo" placeholder="Sexo">
