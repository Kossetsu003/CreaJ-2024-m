                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:flex p-4 bg-white items-center justify-between shadow-md">
                        ...
                        <div class="flex gap-8">
                            ...
                            <a href="./VendedorMibuzon"
                                class="font-bold uppercase text-sm lg:text-base hover:text-gray-300">Buzon</a>
                    ...
                    <div class="w-full bg-white text-gray-900">
                        <header class="bg-gray-200 py-4 px-8 flex flex-col md:flex-row justify-between md:items-center">
                            ...
                            <div class="flex items-center">
                                <input type="search"
                                    class="px-4 text-gray-900 py-2 rounded-md border border-gray-300 focus:outline-none"
                                    placeholder="Buscar Puestos">
                                <button class="ml-2 p-2 rounded-md bg-gray-300 hover:bg-gray-400">
                                    <img width="24" class="" src="{{ asset('imgs/lupa.png') }}"
                                        alt="Search Icon" />
                                </button>
                            </div>
                        </header>
                        ...
                        <nav
                            class="bg-gray-300 py-4 px-8 grid grid-cols-[1fr_max-content] gap-2 justify-between items-center">
                            <div class="flex overflow-auto min-w-full gap-4 items-center">
                                <button
                                    class="min-w-max px-3 flex items-center gap-2 py-2 rounded-md text-sm bg-gray-200 hover:bg-gray-400">
                            ...
                            <div>
                                <button class="px-3 py-2 rounded-md  text-sm bg-gray-200 hover:bg-gray-400">
                                    <img class="w-6 invert" src="{{ asset('imgs/SettingIcon.png') }}"
                                        alt="User Icon" />
                                </button>
                            </div>
                        </nav>
                            ...
                            <div class="bg-gray-100 rounded-md shadow-md">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex justify-between items-center mt-2">
                                        <div class="flex items-center">
                                            <img class="w-5 h-5 mr-1" src="{{ asset('imgs/estrella.png') }}"
                                                alt="Rating Icon" />
                    ...
                    <div class="mt-14  w-[90%] mx-auto md:text-[30px]">
                        ...
                        <div class="flex justify-between  w-[90%] mx-auto"> <!--Contenedor Principal-->
                            ...
                            <div class="mt-3 md:hidden">
                                <img class="w-4 rounded-full " src="{{ asset('imgs/flecha-izquierda.png') }}"
                                    alt="User Icon">
                            </div>
                        </div>
                        <!--Fin Principal-->
                        ...
                        <div class="flex flex-col gap-6 md:gap-0 md:grid grid-cols-3 text-white  p-12">
                            ...
                            <div class="md:self-end md:justify-self-end pb-4">
                                ...
                                <div class="flex gap-2">
                                    <div
                                        class="w-8 aspect-square flex justify-center items-center bg-white rounded-full">
                                        <img width="18" class="invert" src="{{ asset('imgs/facebook.png') }}"
                                            alt="">
                                    </div>
                                    <div
                                        class="w-8 aspect-square  flex justify-center items-center bg-white rounded-full">
                                        <img width="18" class="invert" src="{{ asset('imgs/google.png') }}"
                                            alt="">
                                    </div>
                                    <div
                                        class="w-8 aspect-square flex justify-center items-center bg-white rounded-full">
