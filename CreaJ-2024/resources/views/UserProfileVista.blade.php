       ...
       <div class="bg-indigo-300 h-[160px] flex items-center justify-center">
        ...
        <div class="w-[50%] mx-auto mt-16">
            <div class=" mx-auto flex items-center">
                ...
                <a href="UserHistorialPedidos"><h3 class="flex-grow text-left font-bold ml-3">Historial De pedidos</h3></a <!-- Alineado a la derecha -->
            </div>

            <div class=" mx-auto flex items-center mt-10">
                <img class="w-5" src="{{ asset('imgs/credit-card.png') }}" alt="User Icon">
                <a href="UserEstadoPedidos"><h3 class="flex-grow text-left font-bold ml-5">Estado De pedidos</h3></a> <!-- Alineado a la derecha -->
            </div>


            <div class=" mx-auto flex items-center mt-10">
                <img class="w-5" src="{{ asset('imgs/megaphone.png') }}" alt="User Icon">
                <a href="UserCarritoGeneral"><h3 class="flex-grow text-left font-bold ml-5">Carrito</h3></a> <!-- Alineado a la derecha -->
            </div>
