                ...
                <div class="pb-[7rem] mt-10 space-y-4">
                    ...
                    <div class="flex justify-center">
                        <input type="text" name="contrasena"
                            class="border-1 rounded border w-80 h-9 pl-5 text-xs bg-gray-100 shadow-md border-gray-400 form-control @error('contrasena') is-invalid @enderror"
                            value="{{ old('contrasena', $vendedor?->contrasena) }}" id="contrasena"
                    ...
                    <div class="flex justify-center">
                        <input type="text" name="contrasena-comprobar"
                            class="border-1 rounded border w-80 h-9 pl-5 text-xs bg-gray-100 shadow-md border-gray-400 form-control @error('contrasena') is-invalid @enderror"
                            value="{{ old('contrasena', $vendedor?->contrasena) }}" id="contrasena"
                    ...
                    <div class="flex justify-center">
                        <input type="text" name="telefono"
                            ...
                            placeholder="Digite el Telefono del Vendedor">
                        {!! $errors->first('telefono', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
                    </div>
                    <div class="flex justify-center">
                        <input type="text" name="numero_puesto"
                            ...
                            placeholder="Escriba el Numero Puesto">
                        {!! $errors->first(
                            'numero_puesto',
                    ...
                    <div class="flex justify-center">
                        <input type="text" name="fk_mercado"
                            ...
                            value="{{ old('fk_mercado', $vendedor?->fk_mercado) }}" id="fk_mercado"
                            placeholder="Fk Mercado">
                        {!! $errors->first('fk_mercado', '<div class="invalid-feedback" role="alert"><strong>:message</strong></div>') !!}
                    </div>

                    <div class="flex justify-center mt-16">
                        <button class="btn btn-primary bg-red-600 w-72 h-10 text-white font-bold rounded-md">Registrar
                            Vendedor</button>
                    </div>
