        ...
        <div class="w-72 h-96 mx-auto">
            ...
            <form method="POST" action="{{ route('admin-vendedors.store') }}" role="form" enctype="multipart/form-data">
                ...
                @endif
                    ...
                    <div class="flex justify-center">
                        <input type="password" name="contrasena" class="border-1 rounded border w-80 h-9 pl-5 text-xs bg-gray-100 shadow-md border-gray-400 form-control @error('contrasena') is-invalid @enderror" value="{{ old('contrasena') }}" id="contrasena" placeholder="Escriba su Contraseña">

                    </div>
                    <div class="flex justify-center">
                        <input type="password" name="contrasena_confirmation" class="border-1 rounded border w-80 h-9 pl-5 text-xs bg-gray-100 shadow-md border-gray-400 form-control @error('contrasena_confirmation') is-invalid @enderror" value="{{ old('contrasena_confirmation') }}" id="contrasena_confirmation" placeholder="Confirme su Contraseña">
