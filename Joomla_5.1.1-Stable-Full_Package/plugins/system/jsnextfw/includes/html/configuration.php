		...
		<div class="horizontal-form">
			...
			<div class="tab-content">
				<div class="tab-pane fade in active" id="configuration-pane" role="tabpanel">
					<?php JsnExtFwHtml::renderSettingsForm($component, '#toolbar-apply a, #toolbar-apply .button-apply, #toolbar-apply .btn-success'); ?>
				</div>
				...
				<div class="tab-pane fade" id="global-params-pane" role="tabpanel">
					<?php JsnExtFwHtml::renderSettingsForm('jsnextfw', '#toolbar-apply a, #toolbar-apply .button-apply, #toolbar-apply .btn-success', null, 'config/framework.json'); ?>
				</div>
			</div>
		</div>
	</div>
