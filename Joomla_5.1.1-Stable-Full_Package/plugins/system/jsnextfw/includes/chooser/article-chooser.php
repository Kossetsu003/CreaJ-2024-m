 ...
 * @since    1.0.0
 */
class JsnExtFwChooserArticleChooser extends JsnExtFwChooser
{
	/**
	 ...
	 * @var  string
	 */
	protected $query_params = 'view=articles&tmpl=component&layout=modal';
	 ...
	 * @var  string
	 */
	protected $view_link = 'index.php?option=com_content&view=article&id=';
}
