 ...
 * @since    1.0.0
 */
class JsnExtFwAjaxContactSelector extends JsnExtFwAjaxSelector
{
	/**
	 ...
	 * @var  string
	 */
	protected $query_params = 'view=contacts&tmpl=component&layout=modal';
	 ...
	 * @var  string
	 */
	protected $edit_link = 'index.php?option=com_contact&task=contact.edit&id=';
	 ...
	 * @var  string
	 */
	protected $view_link = 'index.php?option=com_contact&view=contact&id=';
}
