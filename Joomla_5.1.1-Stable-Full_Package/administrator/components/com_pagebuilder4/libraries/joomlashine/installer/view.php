 ...
 * @since    1.0.0
 */
class JSNInstallerView extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		// Load assets
		$jv = JSNPageBuilder4Helper::getJoomlaVersion();

		if (version_compare($jv, '3.0', '<'))
		{
		...
		else
		{
			...
			else
			{
				...
				$this->doc->addScript(JUri::root(true) . '/administrator/components/com_' . $component . '/assets/js/installer/jquery_compat.js');
			}
		}
